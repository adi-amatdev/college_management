...
urlpatterns = [
    ...
    url(r'api/teachers_list/$',TeacherList.as_view(),name='teacher_list'),
    url(r'api/hostel_list/$',HostelList.as_view(),name='hostel_list'),
    url(r'api/imfinfo_list/$',ImpInfoList.as_view(),name='impinfo_list'),
    url(r'api/departmentinfo_list/$',DepartmentList.as_view(),name='department_list'),
    url(r'api/departmentcourses_list/$',DepartmentList.as_view(),name='departmentcourse_info'),
